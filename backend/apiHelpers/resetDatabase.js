...
const resetDatabase = (db) => {
  // sql statements
  const createTable =
    "CREATE TABLE players(name TEXT NOT NULL PRIMARY KEY, level INTEGER, highScore1 INTEGER, highScore2 INTEGER, highScore3 INTEGER, bossCleared INTEGER, totalHighScore INTEGER)";
