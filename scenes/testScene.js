...
class testScene extends Scene {
  ...
  update() {
    ...
    this.debugText.setText("fps: " + this.game.loop.actualFps.toString() + "\n"
			   + "y: " + this.ship.y + "\n"
			   + "y velocity: " + this.ship.body.velocity.y.toString() + "\n"
			   + "x velocity: " + this.ship.body.velocity.x.toString() + "\n");   
    ...
    if (Phaser.Input.Keyboard.JustDown(this.keys.SPACE)) {
      console.log("shooted");
      this.laserGroup.fireLaser(this.ship.x + (this.ship.body.velocity.x * .03), this.ship.y - 48, this.ship.body.velocity.x, this.ship.body.velocity.y);
    }
  }
}
